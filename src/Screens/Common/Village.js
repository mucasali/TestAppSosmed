...
const VillageSelect = observer(props => {
  const {villages, villageState} = useRegionStore();
  const {fetching} = villageState;
  ...
  try {
    ...
    console.log('ERROR Village ', err.message);
    return null;
  }
});

VillageSelect.defaultProps = {
